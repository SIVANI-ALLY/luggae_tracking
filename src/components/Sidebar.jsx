...
const Sidebar = () => {
  ...
  const menuItems = [
    { label: 'Dashboard', path: '/qc-dashboard' },
    { label: 'Incident Log', path: '/historyqa'},
    { label: 'Inspection Log', path: '/incident' },
    { label: 'Report Hub', path: '/qa-report-hub' },
  ];
  ...
  return (
    <div style={styles.sidebar}>
      ...
      <div style={styles.userSection}>
        <div style={styles.avatar}>QA</div>
        <div>
          <div style={styles.userName}>Quality Officer</div>
          <div style={styles.userType}>Manual Review </div>
        </div>
      </div>
